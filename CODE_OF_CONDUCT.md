# Code of Conduct - BaguetteFrench
...
When an incident does occur, it is important to report it promptly. To report a possible violation, please write an e-mail to support@lobigart.de. Make sure, that it is possible to understand that the mail is about an issue just from looking at the title.
