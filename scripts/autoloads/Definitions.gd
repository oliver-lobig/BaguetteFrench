...
enum Units {UNSET,BIENVENUE,LA_VIE,MES_COPAINS_ET_MOI,ANNIVERSAIRE,ACTIVITES,THEATRE,NOEL,L_ECOLE,MOIS_ET_JOURS_DE_LA_SEMAINE,LA_FAMILLE,VACANCES,RENTREE,ADVENTURES,EN_FAMILLE,MANGER,BREIZH,LES_MEDIAS,LA_COULEUR,ECHANGES}
